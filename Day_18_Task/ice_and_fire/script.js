...
function displayContent(data) {
  ...
  bookDetails.replaceChild(para1, bookDetails.childNodes[0]);
  bookDetails.replaceChild(para2, bookDetails.childNodes[1]);
  bookDetails.replaceChild(para3, bookDetails.childNodes[2]);
  bookDetails.replaceChild(para4, bookDetails.childNodes[3]);
  bookDetails.replaceChild(para5, bookDetails.childNodes[4]);
